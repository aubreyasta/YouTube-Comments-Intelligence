...
Resume at Wave 4 Task 4.1. Wave 3 is complete and verified. `benchmark-data/private/` labels do not exist yet, so Task 4.1 begins with label preparation and no benchmark run. Wave 4 task order is 4.1, then 4.3, then 4.2, because Task 4.2 now scores Qwen predictions that Task 4.3 produces.
