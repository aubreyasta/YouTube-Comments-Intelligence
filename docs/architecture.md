...
Product terms are defined in [README.md](../README.md). Code-identifier mappings are in [AGENTS.md](../AGENTS.md#terminology). The exact HTTP contract is [docs/api-reference.md](api-reference.md).
